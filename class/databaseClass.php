...
class database{
	...
	function __construct(){
		try {
			$this->pdo = new PDO('mysql:host=localhost;dbname='.setting::DATABASE, setting::USER_DATABASE, setting::MYSQL_PASSWORD);
			$this->pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			$this->pdo->query('SET NAMES utf8');

			$this->pdoLog = new PDO('mysql:host=localhost;dbname='.setting::DATABASE_LOG, setting::USER_DATABASE, setting::MYSQL_PASSWORD);
